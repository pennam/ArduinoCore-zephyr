...
public:
    ...
    // the irq routine supports 8 levels of grayscale (3 bits), but usually the conversion tools to grayscale
    // will convert to 256 levels (8 bits). Call this accorgingly to your source.
    // The biggest value in the framebuffer should be 2^max_grayscale_bits - 1 (eg. 7 or 255)
